...
import online.ors.oldraddisold.activity.MainActivity;
import online.ors.oldraddisold.util.Preference;

import static online.ors.oldraddisold.activity.ORSActivity.EXTRA_DATA;
...
public class ApiTask extends AsyncTask<String, Integer, String> {
	 ...
	 */
	ApiTask(@NonNull Context context, @NonNull CharSequence progressMessage, @NonNull OnResponseListener
	 ...
	 * @param requestCode : Request code to be returned with callback
	 */
	ApiTask(@NonNull Context context, @NonNull OnResponseListener listener, int requestCode, Bundle savedData) {
		mContext = context;
		mListener = listener;
	...
	protected void onPreExecute() {
		...
		if (mProgressMessage != null) {
			...
			Drawable drawable = mContext.getResources().getDrawable(online.ors.oldraddisold.R.drawable.progress);
